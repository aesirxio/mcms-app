...
class ItemsFormActionBar extends Component {
  render() {
    const { t, history, path } = this.props;
    return (
      <div className="d-flex">
        ...
        <button className="btn btn-outline-secondary px-16 py-11 text-capitalize rounded-1 me-16 text-blue-0 bg-white border-gray-200">
          {t("txt_save_close")}
        </button>
        <button className="btn btn-success px-16 py-11 text-capitalize fw-semibold rounded-1 d-flex align-items-center">
