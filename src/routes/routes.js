...
const BehaviorOverviewPage = lazy(() =>
  import("../containers/Behavior/Overview")
);
const BehaviorClickAnchorPage = lazy(() =>
  import("../containers/Behavior/ClickAnchor")
);
const UTMTrackingPage = lazy(() =>
  import("../containers/Behavior/UTMTracking")
);
